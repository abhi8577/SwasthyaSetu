...
public class PatientController {
	...
	@GetMapping("/findAppointmentByMobileNumber/{mobileNo}")
	public Response findAppointmentByMobileNumber(@PathVariable("mobileNo") Long mobileNo) {
		return patientService.findAppointmentByMobileNumber(mobileNo);
